    ...
    <div className="w-fit bg-black/25  min-w-100  pb-10">
      ...
      <div className=" flex flex-col h-[200px] w-[285px] m-auto p-3 mt-3">
        ...
        <div className="flex flex-row m-auto w-[285px]">
          <button className="hover:bg-green-400 bg-green-500 h-[50px] w-[120px] rounded-t-lg rounded-b-lg text-white text-[20px] font-medium ">
            Sign
          </button>
          <button className="hover:bg-red-400 bg-red-500 h-[50px] w-[120px] rounded-t-lg rounded-b-lg text-white text-[20px] font-medium m-auto">
            Reject
          </button>
        </div>
      </div>
